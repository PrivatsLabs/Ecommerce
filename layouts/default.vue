  ...
  <div>
    ...
    <div class="top-bar shadow">
      <div style="width: 100px;">
       ...
       <nuxt-link to="/"><h1>LOGO</h1></nuxt-link>
      </div>

      <div style="display:flex; justify-content: space-between; width: 120px">
       

        <svg @click="search" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-search"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
    ...
    <footer>
        ...
        <p>Le site de complements alimentaires sains.</p>
        <br>
        <span class="text-2xl">Menu</span> <br>

        <a href="#">Produits de A a Z</a> <br>
        <a href="#">Prise de poids</a> <br>
        <a href="#">Bien-etre</a> <br>
        <a href="#">Librairie</a> <br>
        <a href="#">Blog</a> <br>

        <br>

        <span class="text-2xl">Informations</span> <br>
